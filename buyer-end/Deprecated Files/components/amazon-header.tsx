      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex items-center p-2">
          <div className="flex-shrink-0 mr-4">
            <img
              src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-xmQF8fyhWhYF8nRWysLpSdQsVr1EXa.png"
              alt="Amazon Logo"
        ...
        <nav className="flex space-x-6 px-4 py-1 text-sm bg-gray-800 overflow-x-auto">
