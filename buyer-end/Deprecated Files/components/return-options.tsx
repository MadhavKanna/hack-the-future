      ...
      {decision === "reject" ? (
        ...
        <>
          <div className="space-y-3 mb-4">
            {decision === "refund" && (
              <div
                className={`border rounded-md p-4 cursor-pointer ${
                  selectedOption === "refund" ? "border-green-500 bg-green-50" : "border-gray-200 hover:border-gray-300"
                }`}
                ...
                <div className="flex items-center">
                  <div
                    className={`h-5 w-5 rounded-full border flex items-center justify-center mr-3 ${
                      selectedOption === "refund" ? "border-green-500 bg-green-500" : "border-gray-300"
                    }`}
                  >
            ...
            <div
              className={`border rounded-md p-4 cursor-pointer ${
                selectedOption === "credit" ? "border-green-500 bg-green-50" : "border-gray-200 hover:border-gray-300"
              }`}
            ...
            >
              <div className="flex items-center">
                <div
                  className={`h-5 w-5 rounded-full border flex items-center justify-center mr-3 ${
                    selectedOption === "credit" ? "border-green-500 bg-green-500" : "border-gray-300"
                  }`}
                >
          ...
          <button
            ...
            className="w-full bg-green-600 text-white py-2 px-4 rounded-md hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 disabled:bg-gray-300 disabled:cursor-not-allowed"
          >
            {loading ? (
