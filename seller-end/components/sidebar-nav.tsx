    ...
    <div className="flex h-screen w-64 flex-col border-r bg-white">
          ...
          <div key={item.title}>
            {item.submenu ? (
              <div className="space-y-1">
                <div
                  className={cn(
                    ...
                    pathname.startsWith(`/${item.title.toLowerCase().replace(/\s+/g, "-")}`)
                    ...
                    {item.submenu.map((subItem) => (
                      <Link
                        ...
                        className={cn(
                          ...
                          pathname === subItem.href ? "bg-blue-50 text-[#0088CC]" : "text-gray-600 hover:bg-gray-100",
                        )}
                      >
              ...
              <Link
                ...
                className={cn(
                  "flex items-center rounded-md px-3 py-2 text-sm font-medium",
                  pathname === item.href ? "bg-blue-50 text-[#0088CC]" : "text-gray-600 hover:bg-gray-100",
                )}
              >
                <item.icon className="mr-3 h-5 w-5" />
                {item.title}
      ...
      <div className="border-t p-4">
        <Link
          ...
          className={cn(
            "flex items-center rounded-md px-3 py-2 text-sm font-medium",
            pathname === "/settings" ? "bg-blue-50 text-[#0088CC]" : "text-gray-600 hover:bg-gray-100",
          )}
        >
