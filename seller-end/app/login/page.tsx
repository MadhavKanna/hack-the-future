            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <Link href="/forgot-password" className="text-sm text-[#0088CC]">
                    Forgot password
                  </Link>
                </div>
              ...
              <Button className="w-full bg-[#1a73e8] hover:bg-[#1a73e8]/90">Sign in</Button>
              ...
              <Button className="w-full h-12 text-lg font-medium bg-purple-600 hover:bg-purple-700 text-white" asChild>
