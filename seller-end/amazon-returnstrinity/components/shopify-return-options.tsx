...
interface ShopifyReturnOptionsProps {
...
export function ShopifyReturnOptions({ decision, itemName, itemPrice, onComplete }: ShopifyReturnOptionsProps) {
  ...
  return (
    <div className="bg-white border border-gray-200 rounded-lg shadow-sm p-4">
      <h3 className="text-lg font-medium mb-4 text-[#004C3F]">Return Options</h3>
      ...
      {decision === "reject" ? (
        ...
        <>
          <div className="space-y-3 mb-4">
                ...
                <div className="flex items-center">
                  <div
                    className={`h-5 w-5 rounded-full border flex items-center justify-center mr-3 ${
                      selectedOption === "refund" ? "border-[#008060] bg-[#008060]" : "border-gray-300"
                    }`}
                  >
            ...
            <div
              className={`border rounded-md p-4 cursor-pointer ${
                selectedOption === "credit" ? "border-[#008060] bg-[#f1f9f7]" : "border-gray-200 hover:border-gray-300"
              }`}
            ...
            >
              <div className="flex items-center">
                <div
                  className={`h-5 w-5 rounded-full border flex items-center justify-center mr-3 ${
                    selectedOption === "credit" ? "border-[#008060] bg-[#008060]" : "border-gray-300"
                  }`}
                >
                ...
                <div className="flex-1">
                  <div className="flex items-center">
                    <CreditCard className="h-5 w-5 text-[#008060] mr-2" />
          ...
          <button
            ...
            className="w-full bg-[#008060] text-white py-2 px-4 rounded-md hover:bg-[#006e52] focus:outline-none focus:ring-2 focus:ring-[#008060] focus:ring-offset-2 disabled:bg-gray-300 disabled:cursor-not-allowed"
          >
            {loading ? (
