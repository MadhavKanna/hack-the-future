...
interface ShopifyAIJudgmentProps {
  userScore: number
...
export function ShopifyAIJudgment({ userScore, onAnalysisComplete }: ShopifyAIJudgmentProps) {
  ...
  return (
    <div className="bg-white border border-gray-200 rounded-lg shadow-sm p-4">
      <div className="flex justify-between items-center mb-4">
        <h3 className="text-lg font-medium text-[#004C3F]">AI Return Analysis</h3>
        <div className="flex gap-2">
          ...
          {!result && (
            <button
              ...
              className="px-3 py-1 text-sm bg-[#008060] text-white rounded-md hover:bg-[#006e52] disabled:bg-gray-300 disabled:cursor-not-allowed"
            >
              {loading ? (
          ...
          {result.final_decision !== "refund" && !humanReviewRequested && (
            <div className="mt-4">
              <button
                ...
                className="w-full flex items-center justify-center py-2 px-4 bg-[#004C3F] text-white rounded-md hover:bg-[#003D32] transition-colors"
              >
                {humanReviewLoading ? (
                  <>
                    <Loader2 className="h-4 w-4 mr-2 animate-spin" />
